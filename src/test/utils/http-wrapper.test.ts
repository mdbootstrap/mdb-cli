...
describe('Utils: HttpWrapper', () => {
    ...
    let httpRequestStub: SinonStub,
        httpsRequestStub: SinonStub,
        httpWrapper: HttpWrapper,
        fakeRequest: { on: SinonStub, write: SinonStub, end: SinonStub },
        fakeResponse: { on: SinonStub, headers: object, statusCode?: number };
